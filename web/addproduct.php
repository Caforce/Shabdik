...
if (isset($_POST["add_product"])) {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM products WHERE title='{$title}'")) > 0) {
        echo "<script>alert('{$email} - This product has already in the list.');</script>";
    } else {
                ...
                <div class="col-2">
                    <div class="form-container" style="height:650px;">
                        ...
                        <form action="" method="post" class="form">
                            ...
                            <div class="input-field">
                                <input type="number" name="price" id="cpassword" class="input" placeholder="Enter your price" required>
                            </div>
